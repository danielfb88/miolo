 ...
 * EDITMASK
 */
Miolo.editMask = Class.create();

Miolo.editMask.prototype = {
    initialize: function(element, mask, optional, errMsg) {
...
//            this.element.value = this.displayMask(mask);
            ...
            xAddEventListener(element, 'KeyPress', this.process);
            xAddEventListener(element, 'Focus', this.onEnter);
            xAddEventListener(element, 'Submit', this.onSubmit);
//            xAddEventListener(element, 'KeyUp', this.process);
        }
    },
...
//        xAddEventListener(element, 'Blur', element.editMask.onExit);
    },
    onExit: function(event) {
        ...
        if (ok)
        {
            xRemoveEventListener(element, 'Blur', element.editMask.onExit);
        }
        return ok;
    },
