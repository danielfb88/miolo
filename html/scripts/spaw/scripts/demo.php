<?php
    ...
    //                                www.solmetra.com
    // ================================================
    // $Revision: 1.2 $, $Date: 2005/04/03 15:52:55 $
    // ================================================
    ...
    $_root = 'c:/program files/apache group/apache/htdocs/';
    define('DR', $_root);
    unset($_root);
...
<html>
    ...
    <body>
        ...
        <p>
            Hi... this script shows various ways of using
            <a href = "http://www.solmetra.com">Solmetra</a>SPAW web based WYSIWYG editor control.</p>

        <p>
            Below you will see various modes of the control and parameters that caused it to look like this.</p>

        <p>
            <i>Note: in case you can't see the editors or get errors, it is most likely that you haven't configured the
            control properly. Check the documentation details.</i></p>

        <p>
            Pay attention that you can use multiple instances of the control on the same page and with completely
            different settings... pretty cool ;)</p>

        <p>
            For more info on how to use the control check out the documentation or analyze this script (demo.php) and
            control's source. You can also try asking in
            <a href = "http://sourceforge.net/forum/?group_id=77954" target = "_blank">SourceForge.net forums</a></p>
        ...
        <form name = "spawdemo" method = "post" action = "demo.php">
            ...
            <p>
                This is the simpliest usage of the control with all the default parameters</p>
            ...
            <?php
                $sw = new SPAW_Wysiwyg('spaw1'/*name*/,
                                       isset($HTTP_POST_VARS['spaw1']) ? stripslashes(
                                                                             $HTTP_POST_VARS['spaw1']) : ''/*value*/);
                $sw->show();
            ?>
            ...
            <p>
                Now let's try something else... let's specify width and height of the control, Lithuanian language and
                "sidetable" toolbar mode.</p>
            ...
            <?php
                $sw = new SPAW_Wysiwyg('spaw2'/*name*/, isset($HTTP_POST_VARS['spaw2']) ? stripslashes($HTTP_POST_VARS['spaw2']) : ''/*value*/, 'lt'/*language*/, 'sidetable'/*toolbar mode*/, 'default'/*theme*/, '550px'/*width*/, '350px'/*height*/);
                $sw->show();
            ?>
            ...
            <p>
                This time we will check our 'classic' (not so nice ;) theme with 'full' toolbar.</p>
            ...
            <p>
                There's also a 'mini' toolbar (with minimum features without possibility to switch to code (html) mode) useful for short summary text fields.</p>
            ...
            <?php
                $sw = new SPAW_Wysiwyg('spaw4'/*name*/, isset($HTTP_POST_VARS['spaw4']) ? stripslashes($HTTP_POST_VARS['spaw4']) : ''/*value*/, 'en'/*language*/, 'mini'/*toolbar mode*/, ''/*theme*/, '250px'/*width*/, '50px'/*height*/);
                $sw->show();
            ?>
            ...
            <p>
                You can pass an url of the stylesheet file to be used for control's content to the consturctor like we do below</p>
            ...
            <?php
                $sw = new SPAW_Wysiwyg('spaw5'/*name*/, isset($HTTP_POST_VARS['spaw5']) ? stripslashes($HTTP_POST_VARS['spaw5']) : ''/*value*/, 'en'/*language*/, 'mini'/*toolbar mode*/, ''/*theme*/, '250px'/*width*/, '90px'/*height*/, 'scripts/demo_red.css'/*stylesheet file*/);
                $sw->show();
            ?>
            ...
            <?php
                ...
                // pass $demo_array to the constructor
                $sw = new SPAW_Wysiwyg('spaw6'/*name*/, isset($HTTP_POST_VARS['spaw6']) ? stripslashes($HTTP_POST_VARS['spaw6']) : ''/*value*/, 'en'/*language*/, 'default'/*toolbar mode*/, ''/*theme*/, '550px'/*width*/, '90px'/*height*/, ''/*stylesheet file*/, $demo_array/*dropdown data*/);
                $sw->show();
            ?>
