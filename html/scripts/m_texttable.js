...
Miolo.textTable = Class.create();

Miolo.textTable.prototype = {
    initialize: function(id,zebra,cols) {
		this.id = id; 
	...
	add: function(fields) {
        var tbody = xGetElementsByTagName('TBODY',this.table).item(0);
        var rows = xGetElementsByTagName('TR',tbody);
    	if (fields.length > 0) {
