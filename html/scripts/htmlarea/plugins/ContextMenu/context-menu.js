...
//
// $Id: context-menu.js,v 1.2 2005/04/03 15:52:21 ematos Exp $
...
ContextMenu._pluginInfo = { name: "ContextMenu",                         version: "1.0",
                            developer: "Mihai Bazon",                    developer_url: "http://dynarch.com/mishoo/",
                            c_owner: "dynarch.com",                      sponsor: "American Bible Society",
                            sponsor_url: "http://www.americanbible.org", license: "htmlArea"
};
...
ContextMenu.prototype.onGenerate = function()
    ...
    HTMLArea._addEvents(doc, ["contextmenu"], function(event)
        {
...
ContextMenu.prototype.getContextMenu = function(target)
    ...
    if (selection)
        menu.push(                               [i18n["Cut"], function()
            {
            editor.execCommand("cut");
            } , null, config.btnList["cut"][1]], [i18n["Copy"], function()
            {
            editor.execCommand("copy");
            } ,                                   null,         config.btnList["copy"][1]]);

    menu.push([i18n["Paste"], function()
        {
    ...
    for (;target; target = target.parentNode)
        ...
        switch (tag)
            ...
            case "img":
                ...
                elmenus.push(null, [i18n["Image Properties"],                 function()
                    {
                    editor._insertImage(img);
                    } ,             i18n["Show the image properties dialog"], config.btnList["insertimage"][1]]);
            ...
            case "a":
                ...
                elmenus.push(                                                                                                                                                                                                                                                         null,
                    ...
                    editor.execCommand("createlink", true);
                                                                                                                                                                                                                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                                                                                                                                                                                                                         + link.href,
                                                                                                                                                                                                                                                                                                                                                                                                                                     config.btnList["createlink"][1]], [i18n["Check Link"],
                                                                                                                                                                                                                                                                                                                                                                                                                                                                        function()
                    {
            ...
            case "td":
                ...
                elmenus.push(null, [i18n["Cell Properties"],                       function()
                    {
                    tableOperation("TO-cell-prop");
                    } ,             i18n["Show the Table Cell Properties dialog"], config.btnList["TO-cell-prop"][1]]);
            ...
            case "tr":
                ...
                elmenus.push(                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   null,
                    ...
                    tableOperation("TO-row-prop");
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    config.btnList["TO-row-prop"][1]],                                                                                                                                                                                                                             [i18n["Insert Row Before"],
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    function()
                    {
                    tableOperation("TO-row-insert-above");
                    } ,                                                                                                                                                                                                                         i18n["Insert a new row before the current one"],
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    config.btnList["TO-row-insert-above"][1]],                                                                                         [i18n["Insert Row After"],
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        function()
                    {
                    tableOperation("TO-row-insert-under");
                    } ,                                                                                                                                                                                                                                                                     i18n["Insert a new row after the current one"],
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        config.btnList["TO-row-insert-under"][1]], [i18n["Delete Row"],
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    function()
                    {
            ...
            case "table":
                ...
                elmenus.push(                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   null,
                    ...
                    tableOperation("TO-table-prop");
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               config.btnList["TO-table-prop"][1]],                                                                                                                                                                                                                               [i18n["Insert Column Before"],
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   function()
                    {
                    tableOperation("TO-col-insert-before");
                    } ,                                                                                                                                                                                                                                   i18n["Insert a new column before the current one"],
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   config.btnList["TO-col-insert-before"][1]],                                                                                         [i18n["Insert Column After"],
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        function()
                    {
                    tableOperation("TO-col-insert-after");
                    } ,                                                                                                                                                                                                                                                                                i18n["Insert a new column after the current one"],
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        config.btnList["TO-col-insert-after"][1]], [i18n["Delete Column"],
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    function()
                    {
            ...
            case "body":
                elmenus.push(                                      null, [i18n["Justify Left"], function()
                    {
                    editor.execCommand("justifyleft");
                    } , null, config.btnList["justifyleft"][1]],   [i18n["Justify Center"], function()
                    {
                    editor.execCommand("justifycenter");
                    } , null, config.btnList["justifycenter"][1]], [i18n["Justify Right"], function()
                    {
                    editor.execCommand("justifyright");
                    } , null, config.btnList["justifyright"][1]],  [i18n["Justify Full"],
                                                                    function()
                    {
    ...
    if (selection && !link)
        menu.push(null, [i18n["Make link"],     function()
            {
            editor.execCommand("createlink", true);
            } ,          i18n["Create a link"], config.btnList["createlink"][1]]);

    for (var i in elmenus)
        menu.push(elmenus[i]);

    menu.push(null, [i18n["Remove the"] + " &lt;" + currentTarget.tagName + "&gt; " + i18n["Element"], function()
        {
...
ContextMenu.prototype.popupMenu = function(ev)
    ...
    if (!HTMLArea.is_ie)
        ...
        doc = popup.document;
        doc.open();
        doc.write("<html><head><style type='text/css'>@import url(" + _editor_url
                      + "plugins/ContextMenu/menu.css); html, body { padding: 0px; margin: 0px; overflow: hidden; border: 0px; }</style></head><body unselectable='yes'></body></html>");
        doc.close();
        }
    ...
    for (var i = 0; i < options.length; ++i)
        ...
        if (!option)
            ...
            var label = option[0];
            item.className = "item";
            item.__msh = { item: item,              label: label, action: option[1], tooltip: option[2] || null,
                           icon: option[3] || null, activate: function()
                {
                self.closeMenu();
