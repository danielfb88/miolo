...
class Cezpdf extends Cpdf
{
    ...
    var $y = 0.0;                      // this is the current vertical positon on the page of the writing point, very important
    var $ezPages = array(
    ...
    function ezText($text, $size = 0, $options = array(
        ),          $test = 0)
    {
    ...
    function execTemplate($id, $data = array(
        ),                $options = array(
        ))
    {
